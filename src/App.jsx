...
const App = () => {
  ...
  useEffect(() => {
    ...
    //can't check if the user has voted if we haven't retrieved the proposals yet
    if(!proposals.length) {
      return;
    }
  ...
  if(error instanceof UnsupportedChainIdError) {
    return(
    <div>
      <h2> Please connect to the Rinkeby test network on Ethereum</h2>
      <p>This dapp only works on the Rinkeby network, so please switch networks in your connected wallet.</p>
    </div>
    );
  }
